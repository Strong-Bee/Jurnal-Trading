        ...
        <div id="app-sidepanel" class="app-sidepanel">
            ...
            <div class="sidepanel-inner d-flex flex-column">
                ...
                <div class="app-branding">
                    <a class="app-logo" href="index#"><img class="logo-icon me-2" src="assets/images/app-logo.svg"
                            alt="logo"><span class="logo-text">Jurnal Trading</span></a>
                </div>
                    ...
                    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="docs#">
                                ...
                                <span class="nav-link-text">Catatan Trading</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="charts#">
                                ...
                                <span class="nav-link-text">Strategi & Setup</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            <a class="nav-link" href="help#">
                                ...
                                <span class="nav-link-text">Kalender Trading</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            <a class="nav-link" href="help#">
                                ...
                                <span class="nav-link-text">Analisa Berita</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
